 ...
 */
/**
 * Sequence class allows to create musical phrases or patterns with Tactu5. It's
 * possible to pass an array of Note to the constructor or to add Note objects
 * afterwards. This class automatically clones the Note objects passed.
 * 
 * 
...
public class Sequence implements Cloneable, T5Containers {
	...
	public void setNote(Note note, int index) {
		// TODO setNote(Note note, int index)
		sequence[index] = note;
	}
