...
/**
 * ClusterSequence class allows to create chord sequences with Tactu5. It's
 * possible to pass an array of Cluster datatype to the constructor or to add
 * Cluster objects afterwards. This class automatically clones the Cluster
 * objects passed.
 * 
 * 
...
public class ClusterSequence {
	...
	public void addToCluster(Cluster newC, int idC) {
		...
		// force new cluster duration to old duration, it allows to preserve
		// rythmic pattern even if new cluster contains much longer notes
