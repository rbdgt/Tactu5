 ...
 */
/**
 * Cluster class allows to create chord instances with Tactu5. It's possible to
 * pass an array of Note to the constructor or to add Note objects afterwards.
